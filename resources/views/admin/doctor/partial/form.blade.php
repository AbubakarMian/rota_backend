...
<div class="form-group">
    {!! Form::label('doctor_type') !!}
    {!! Form::select('doctor_type_id',$types,null,["placeholder"=>"Select Type","class"=>"form-control","required"]) !!}
    {{-- <select id="select-example" class="form-control"  name="doctor_type_id"  placeholder="Select doctor_type...">
    @foreach ($type as $t)
