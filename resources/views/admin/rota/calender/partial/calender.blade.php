...
<div class="row bstmonthly" style="display: flex; justify-content: center;position: relative;width: 100%;">
    ...
    <div class="col-sm-8" style="float: left">
        <h2 class="">
            ...
            <div class="mydoctortable">" {!!sizeof($doctors)!!} DOCTOR's MONTHLY TABLE "</div>
    ...
    <table class="table table-striped table table-hover table table-bordered table table-condensed" id="customers">
        ...
        <tbody id="calenderdates">
            <tr class="myboxes">
                ...
                ?>
                @foreach ($monthly_rota->rota_generate_pattern as $date_index=>$item)
                                ...
                                <div class="row" style="margin: 2px">
                                    <div class="col-sm-6 regular_duties">
                                        ...
                                        <select id="dates-field2"
                                            onchange="show_doctors('multiple_line_text_morning_{!!$item->id!!}','{!!$rota->id!!}','{!!$item->duty_date!!}','morning','0',this);"
                                    ...
                                    <div class="col-sm-6 ucc_class">
                                        ...
                                        onchange="show_doctors('ucc_morning_{!!$item->id!!}','{!!$rota->id!!}','{!!$item->duty_date!!}','morning','1',this);"
                        ...
                        <div class="eveningdoctor">
                            ...
                            <div class="">
                                ...
                                <div class="row" style="margin: 2px">
                                    <div class="col-sm-6 regular_duties">
                                        <select id="dates-field2"
                                            onchange="show_doctors('multiple_line_text_evening_{!!$item->id!!}','{!!$rota->id!!}','{!!$item->duty_date!!}','evening','0',this);"
                                            class="multiselect-ui form-control" multiple="multiple" cols="2" rows="2">
                                            @foreach ($doctors as $doctor)
                                            <?php
                                            $selected = '';
                                    ...
                                    <div class="col-sm-6 ucc_class">
                                        <select id="myucc" class="myucc form-control"
                                            onchange="show_doctors('ucc_evening_{!!$item->id!!}','{!!$rota->id!!}','{!!$item->duty_date!!}','evening','1',this);"
                                            class="multiple_line form-control">
                                            <option value="">Ucc</option>
                                            @foreach ($doctors as $doctor)
                                            <?php
                        ...
                        <div class="nightdoctor">
                            ...
                            <div class="">
                                ...
                                <div class="col-sm-6 regular_duties">
                                    ...
                                    <select id="dates-field2"
                                        onchange="show_doctors('multiple_line_text_night_{!!$item->id!!}','{!!$rota->id!!}','{!!$item->duty_date!!}','night','0',this);"
                                        class="multiselect-ui form-control" multiple="multiple" cols="2" rows="2">
                                        @foreach ($doctors as $doctor)
                                        <?php
                                        $selected = '';
                                ...
                                <div class="col-sm-6 ucc_class">
                                    <select id="myucc" class="myucc form-control"
                                        onchange="show_doctors('ucc_night_{!!$item->id!!}','{!!$rota->id!!}','{!!$item->duty_date!!}','night','1',this);"
                                        class="multiple_line form-control">
                                        <option value="">Ucc</option>
                                        @foreach ($doctors as $doctor)
                                        <?php
...
function show_doctors(show_list,temp_rota_id,duty_date,shift,is_ucc,sel){
